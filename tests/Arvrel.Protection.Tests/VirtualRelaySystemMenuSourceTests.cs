...
{
    [TestMethod]
    public void P12RelayMenu_UsesPractitionerFacingSystemVocabulary()
    {
        ...
        // Navigation remains one P1 state machine rather than a second root menu.
        ...
        // Every physical key on the faceplate remains actionable through P1/P1.2.
