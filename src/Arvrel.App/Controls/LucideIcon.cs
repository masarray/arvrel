...
public sealed class LucideIcon : FrameworkElement
{
    ...
    private static IReadOnlyDictionary<LucideIconKind, IconDefinition> BuildDefinitions()
    {
        return new Dictionary<LucideIconKind, IconDefinition>
        {
            ...
            [LucideIconKind.ChevronLeft] = Def(P("M15,18 L9,12 L15,6")),
            [LucideIconKind.CornerDownLeft] = Def(P("M9,10 L4,15 L9,20 M4,15 H16 A4,4 0 0 0 20,11 V4")),
            [LucideIconKind.CornerUpLeft] = Def(P("M9,14 L4,9 L9,4 M4,9 H16 A4,4 0 0 1 20,13 V20")),
            ...
            [LucideIconKind.House] = Def(
                P("M3,9 L12,2 L21,9 V20 A2,2 0 0 1 19,22 H5 A2,2 0 0 1 3,20 Z"),
                P("M9,22 V12 H15 V22")),
            [LucideIconKind.Menu] = Def(P("M4,6 H20 M4,12 H20 M4,18 H20")),
            [LucideIconKind.Star] = Def(P("M12,2 L15.09,8.26 L22,9.27 L17,14.14 L18.18,21.02 L12,17.77 L5.82,21.02 L7,14.14 L2,9.27 L8.91,8.26 Z")),
